...
*   **Status da OS**: O estado atual do ciclo de vida do atendimento, que avança automaticamente conforme ações no sistema. Pode ser: Recebida, Em diagnóstico, Aguardando aprovação interna, Aguardando aprovação do cliente, Aguardando saída de peças, Em execução, Finalizada, Entregue ou Cancelada.
*   **Aguardando saída de peças**: Sub-estado interno entre a aprovação do cliente e o início da execução. A OS permanece nele até o almoxarife confirmar a saída física das peças (transição automática para "Em execução").
...
![Event Storming](event.jpg)

## Link para o diagrama:
https://miro.com/welcomeonboard/TjhreUNSSFFkMU12ZWVuS051K0YvQnh3RithZVVlNzJMOTFSc2l2WGFWN09xeEV0L1pKUjZ3ZHF2c0I2Zzd2bDQ5V3Zla295dXJnd2cyWDZUUlRNbkFvejNYOUlhWG9sQU45UDBVVGc5dEFWUG1TZEVFaUFPMEptWUp1K3hNYVlhWWluRVAxeXRuUUgwWDl3Mk1qRGVRPT0hdjE=?share_link_id=800518857185
...
EM_DIAGNOSTICO → técnico submete plano → AGUARDANDO_APROVACAO_INTERNA
                       ...
                       CANCELADA         AWAITING_PARTS_RELEASE
                                               │
                                     almoxarife confirma saída
