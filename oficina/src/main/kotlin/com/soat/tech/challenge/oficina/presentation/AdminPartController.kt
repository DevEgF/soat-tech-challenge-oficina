...
class AdminPartController(
	...
	fun create(@Valid @RequestBody req: PartRequest): PartResponse = parts.create(req)
	...
	@PutMapping("/{id}")
	fun update(@PathVariable id: UUID, @Valid @RequestBody req: PartRequest): PartResponse =
		parts.update(id, req)

	@PostMapping("/{id}/entrada-mercadoria")
	fun goodsReceipt(
		@PathVariable id: UUID,
		@Valid @RequestBody req: GoodsReceiptRequest,
	): PartResponse = parts.recordGoodsReceipt(id, req)
