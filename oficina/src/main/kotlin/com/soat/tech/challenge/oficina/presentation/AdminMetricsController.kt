...
import com.soat.tech.challenge.oficina.application.MetricsApplicationService
...
class AdminMetricsController(
	private val metrics: MetricsApplicationService,
) {

	@GetMapping("/tempo-medio-execucao-servicos")
	fun averageExecutionTimeByService(): List<AverageServiceTimeResponse> =
